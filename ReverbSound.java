...
/**
 * Based off https://github.com/abvadabra/libgdx-audio-effects/blob/master/core/src/com/badlogic/gdx/backends/lwjgl/audio/ReverbSound.java
 * 
 * @author Jevon
 *
 */
public class ReverbSound extends OpenALSound {
    ...
    static {
        try {
            soundToSourceField = OpenALLwjgl3Audio.class.getDeclaredField("soundIdToSource");
    ...
    public ReverbSound(OpenALLwjgl3Audio audio, OpenALSound actualSound) {
        super(audio);
        this.audio = audio;
